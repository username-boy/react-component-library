...
export var AutoComplete = function (props) {
    ...
    var generateDropdown = function () {
        return (React.createElement(CSSTransition, { in: showDropdown || loading, classNames: "zoom-in-top", timeout: 300, onExited: function () {
                setSugestions([]);
            } },
            React.createElement("ul", { className: "lx-suggestion-list" },
                loading &&
    ...
    return (React.createElement("div", { className: "lx-auto-complete", ref: componentRef },
