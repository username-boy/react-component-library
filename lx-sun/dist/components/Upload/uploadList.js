...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "lx-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "lx-upload-list-item", key: item.uid },
